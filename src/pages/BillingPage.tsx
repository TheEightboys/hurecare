        ...
        try {
            ...
            toast({ 
                ...
                description: selectedNoteId 
                    ? 'Clinical note attached. Navigate to Claims to complete and download.' 
                    : 'Navigate to Claims to complete and download. Consider attaching a clinical note for ICD-10 codes.'
            });
            ...
            <div className="space-y-6">
                ...
                <div ref={headerRef} className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-muted-foreground">Manage invoices and insurance claims</p>
                    </div>
